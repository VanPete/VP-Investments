  ...
  return (
    <div className="space-y-6 mb-8">
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="pt-4 border-t border-gray-200">
              <h3 className="font-semibold text-gray-900 mb-2">Coverage Quality</h3>
              <p className="text-sm text-gray-700 mb-3">
                ...
                {Object.entries(methodologyConfig.interpretation.coverage.guidance).map(
                  ([key, guidanceText]) => (
                    <div key={key} className="flex items-center gap-3 p-2 bg-gray-50 rounded">
                      ...
                      <span className="text-sm text-gray-700">{guidanceText}</span>
                    </div>
                  )
                )}
              </div>
      ...
      <Card className="border-orange-200 bg-orange-50">
        <CardHeader>
          <CardTitle className="text-orange-900">Important Limitations</CardTitle>
        </CardHeader>
        <CardContent>
