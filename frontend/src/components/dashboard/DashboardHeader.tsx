  ...
  return (
    <div className="bg-card border-b border-border shadow-lg rounded-2xl mx-4 mt-4 backdrop-blur-sm [border-image:linear-gradient(to_right,#001F3F,#00AEEF)_1] [border-top:2px_solid]">
      <div className="relative px-6 py-3">
        {/* Layout: Left column (title/stats), Center (logo), Right column (controls) */}
        <div className="flex items-center justify-between">
          {/* Left: Title + Stats stacked */}
          ...
          {/* Center: Large Logo (absolute positioned to center) */}
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
            <Image 
              ...
              width={300} 
              height={90}
              className="h-[70px] w-auto transition-all duration-300 hover:drop-shadow-[0_0_12px_rgba(0,174,239,0.6)]"
              priority
            />
          </div>
